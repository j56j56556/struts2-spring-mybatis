...
.div4{width:max-width;height:184px;background-color:white;background-image:url(bottom.jpg);background-position:center;}
</style>
...
<script>
	...
	function jump(i)
	{
		window.location.href="/meituan/businessInterServlet?businessID="+i;
	}
</script>
</head>
<body>
<div class="container">
	...
	<div class="div1">
		<div class="div1-head"> 
			<span class="icon1"><img src="div1-head-1.jpg" /></span>
	...
	<div class="div2">
		<div class="div2-head">
			<img class="logo" src="logo.png" ><a href=""></a></img>
			<div class="menu">
				<a href=""><span>首页</span></a>
				<a href="/meituan/Myorder"><span>我的订单</span></a>
			...
			<c:forEach items="${home}" var="b1"   >
				...
				<li >
					<div class="business-all">
						<img src="/SSM${b1.getBsImg()}" onclick="jump(${b1.getId()})"/>
						<div class="business-content">
							<div class="business-name">
								<span class="business-name1">${b1.getName()}</span>
							</div>
